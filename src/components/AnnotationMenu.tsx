    ...
    <div className="mt-4 relative animate-in slide-in-from-left-2 duration-200">
      ...
      <div className="ml-4 flex gap-3">
        ...
        <button
          ...
          className="group relative w-12 h-12 rounded-full bg-(--theme-accent) hover:bg-(--theme-primary) flex items-center justify-center shadow-lg hover:shadow-xl transition-all hover:scale-110"
          title="Add Memo"
        >
