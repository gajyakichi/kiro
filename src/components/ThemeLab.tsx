...
:root { --background: #272822; --foreground: #f8f8f2; --card-bg: #272822; --sidebar-bg: #1e1f1c; --hover-bg: rgba(255,255,255,0.1); --theme-primary: #f92672; --theme-primary-bg: rgba(249, 38, 114, 0.15); --theme-accent: #a6e22e; --theme-accent-bg: rgba(166, 226, 46, 0.2); }`
    },
    {
      name: "Atom Material",
      isPreset: true,
...
:root { --background: #263238; --foreground: #eeffff; --card-bg: #263238; --sidebar-bg: #21282d; --hover-bg: rgba(255,255,255,0.1); --theme-primary: #82aaff; --theme-primary-bg: rgba(130, 170, 255, 0.15); --theme-accent: #c3e88d; --theme-accent-bg: rgba(195, 232, 141, 0.2); }`
    },
    {
      name: "Rain Syntax",
      isPreset: true,
...
:root { --background: #1c1f2b; --foreground: #efefef; --card-bg: #232734; --sidebar-bg: #161922; --hover-bg: rgba(255,255,255,0.1); --theme-primary: #94bfff; --theme-primary-bg: rgba(148, 191, 255, 0.1); --theme-accent: #78e1c1; }`
    },
    {
      name: "Futurism",
      isPreset: true,
...
:root { --background: #080b12; --foreground: #c9d1d9; --card-bg: #0d1117; --sidebar-bg: #010409; --hover-bg: rgba(255,255,255,0.1); --border-color: #30363d; --theme-primary: #58a6ff; --theme-primary-bg: rgba(88, 166, 255, 0.1); --theme-accent: #3fb950; }`
    },
    {
      name: "Pumpkin",
      isPreset: true,
...
:root { --background: #1b1811; --foreground: #ffb088; --card-bg: #241f16; --sidebar-bg: #14110b; --hover-bg: rgba(255,255,255,0.1); --border-color: #3d3425; --theme-primary: #d2691e; --theme-primary-bg: rgba(210, 105, 30, 0.1); --theme-accent: #ffb088; }`
    },
    {
      name: "Princess",
      isPreset: true,
...
:root { --background: #fff5f8; --foreground: #634e56; --card-bg: #ffffff; --sidebar-bg: #fde8ef; --hover-bg: rgba(0,0,0,0.05); --border-color: #f9dbe4; --theme-primary: #ff85a2; --theme-primary-bg: rgba(255, 133, 162, 0.1); --theme-accent: #f06292; }`
    },
    {
...
:root { --background: #fdf6e3; --foreground: #657b83; --card-bg: #fdf6e3; --sidebar-bg: #eee8d5; --hover-bg: rgba(0,0,0,0.05); --border-color: #dcd3ba; --theme-primary: #268bd2; --theme-primary-bg: rgba(38, 139, 210, 0.1); --theme-accent: #859900; }`
    },
    {
      name: "Solarized Dark",
      isPreset: true,
...
h1, h2, h3 { color: #268bd2 !important; }
:root { --background: #002b36; --foreground: #839496; --card-bg: #002b36; --sidebar-bg: #073642; --hover-bg: rgba(255,255,255,0.1); --border-color: #073642; --theme-primary: #268bd2; --theme-primary-bg: rgba(38, 139, 210, 0.1); --theme-accent: #859900; }`
    },
    {
      name: "Darcula",
      isPreset: true,
...
:root { --background: #2b2b2b; --foreground: #a9b7c6; --card-bg: #313335; --sidebar-bg: #3c3f41; --hover-bg: rgba(255,255,255,0.1); --border-color: #4e5052; --theme-primary: #cc7832; --theme-primary-bg: rgba(204, 120, 50, 0.15); --theme-accent: #cc7832; }`
    },
    {
      name: "Synthwave '84",
      isPreset: true,
...
:root { --background: #2b213a; --foreground: #fff; --card-bg: #2b213a; --sidebar-bg: #241b35; --hover-bg: rgba(255,255,255,0.1); --border-color: rgba(255,255,255,0.13); --theme-primary: #ff7edb; --theme-primary-bg: rgba(255, 126, 219, 0.2); --theme-accent: #36f9f6; --theme-accent-bg: rgba(54, 249, 246, 0.2); }
...
:root { --background: #22272e; --foreground: #adbac7; --card-bg: #2d333b; --sidebar-bg: #1c2128; --hover-bg: rgba(255,255,255,0.1); --border-color: #444c56; --theme-primary: #539bf5; --theme-primary-bg: rgba(83, 155, 245, 0.15); --theme-accent: #768390; }`
    },
    {
      name: "Winter Blue",
      isPreset: true,
...
:root { --background: #f0f8ff; --foreground: #2c3e50; --card-bg: #ffffff; --sidebar-bg: #e6f2ff; --hover-bg: rgba(0,0,0,0.05); --border-color: #d6eaff; --theme-primary: #007bff; --theme-primary-bg: rgba(0, 123, 255, 0.1); --theme-accent: #17a2b8; }`
    }
  ];
      ...
      <section>
        ...
        <div className="mb-8 p-6 bg-(--card-bg) rounded-2xl border border-(--border-color) flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm overflow-hidden">
          ...
          <div className="flex bg-(--background) p-1.5 rounded-xl border border-(--border-color) gap-1 shrink-0 shadow-sm whitespace-nowrap overflow-x-auto max-w-full no-scrollbar">
             ...
             <button 
                ...
                className={`flex-1 md:flex-none px-6 py-2.5 rounded-lg text-[10px] font-black tracking-widest transition-all duration-300 active:scale-95 ${appIconSet === 'phosphor' ? 'bg-(--theme-primary) text-(--background) shadow-lg ring-2 ring-(--theme-primary)/20' : 'text-(--foreground) opacity-60 hover:opacity-100 hover:bg-(--hover-bg)'}`}
             >
                PHOSPHOR
             </button>
             <button 
                onClick={() => onUpdateIconSet('original')}
                className={`flex-1 md:flex-none px-6 py-2.5 rounded-lg text-[10px] font-black tracking-widest transition-all duration-300 active:scale-95 ${appIconSet === 'original' ? 'bg-(--theme-primary) text-(--background) shadow-lg ring-2 ring-(--theme-primary)/20' : 'text-(--foreground) opacity-60 hover:opacity-100 hover:bg-(--hover-bg)'}`}
             >
                ORIGINAL
             </button>
          </div>
        ...
        <div className="flex flex-wrap gap-6 pt-4 pb-4">
          ...
          {themes.map(theme => (
            ...
            >
              <div className={`w-10 h-10 rounded-full bg-(--hover-bg) border border-(--border-color) flex items-center justify-center text-gray-400 group-hover:scale-110 transition-transform duration-500 ${theme.active ? 'text-(--theme-primary) border-(--theme-primary)/20' : ''}`}>
