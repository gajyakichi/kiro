...
Kiro is a **personal knowledge‑management** tool that combines a Markdown‑style editor, a powerful theme lab, and AI‑powered note absorption. It runs as a cross‑platform desktop app via **Electron** while keeping the modern web stack of **Next.js** at its core. The goal is to provide a seamless, *localized*, *accessible* and *extensible* workspace that can be tailored to any developer’s or researcher’s workflow.
...
> **Major Decision:** Rebrand from *kaihatsunote* to **Kiro** to reflect a broader vision.
...
|------|-------------|-------|----------|
| **QA AI Features** | Validate daily note absorption & task suggestion accuracy. | AI Team | 2026‑02‑07 |
| **Performance Profiling** | Profile ThemeLab live preview, AI cache hits. | Frontend Team | 2026‑02‑14 |
| **Rebrand Asset Rollout** | Update marketing, social, docs with Kiro branding. | Marketing | 2026‑02‑21 |
| **Accessibility Audits** | Run automated WCAG tests, manual review. | QA Team | 2026‑02‑28 |
| **Prompt Vault Polish** | Add tagging, sharing, export. | Backend Team | 2026‑03‑07 |
| **Roadmap Planning** | Define version 2 feature set (e.g., sync, collaboration). | Product | 2026‑03‑14 |
| **CI Enhancements** | Add snapshot tests, code coverage thresholds. | DevOps | 2026‑03‑21 |
